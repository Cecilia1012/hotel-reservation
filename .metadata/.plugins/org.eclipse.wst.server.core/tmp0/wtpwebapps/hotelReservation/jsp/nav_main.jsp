...
%>
	<ul class="nav nav-tabs" style="background-color: rgba(183,226,255,0.6); ">
  		<li role="presentation" class="active"><a href="/hotelReservation/jsp/main.jsp">首页</a></li>
  		<li role="presentation"><a href="/hotelReservation/jsp/order.jsp">订单</a></li>
  		<li role="presentation"><a href="/hotelReservation/jsp/my.jsp">我的</a></li>
  		<span id="out"><%= name %>，欢迎<a href="/hotelReservation/Quit" class="btn btn-primary" id="outBtn">退出</a></span>
	</ul>
</body>
</html>